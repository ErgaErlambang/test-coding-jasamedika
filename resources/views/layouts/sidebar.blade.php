    ...
    <div class="aside-primary d-flex flex-column align-items-center flex-row-auto">
        <div class="aside-brand d-flex flex-column align-items-center flex-column-auto py-5 py-lg-12">
            <a href="{{ route('dashboard') }}">
                <img alt="Logo" src="{{ asset('assets/media/logos/jasamedika_logo.jpg') }}" class="max-h-75px" />
            </a>
        </div>
    </div>
                    ...
                    <div class="aside-menu-wrapper flex-column-fluid px-10 py-5" id="kt_aside_menu_wrapper">
                        <div id="kt_aside_menu" class="aside-menu min-h-lg-800px" data-menu-vertical="1" data-menu-scroll="1">
                            <ul class="menu-nav">
                                ...
                                <!-- BEGIN VEHICLE -->
                                <li class="menu-section">
                                    <h4 class="menu-text">Vehicle Management</h4>
                                    <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                                </li>

                                <!-- Vehicle -->
                                <li class="menu-item menu-item-submenu {{ Request::is('admin/vehicles*') ? 'menu-item-open' : ''}}" aria-haspopup="true" data-menu-toggle="hover">
                                    ...
                                    <div class="menu-submenu">
                                        ...
                                        <ul class="menu-subnav">
                                            @if($role == 'superadministrator')
                                                <li class="menu-item menu-item-submenu {{ Request::is('admin/vehicles/create*') ? 'menu-item-active' : ''}}" aria-haspopup="true" data-menu-toggle="hover">
                                                    <a href="{{ route('vehicle.create') }}" class="menu-link menu-toggle">
                                            ...
                                            @endif
                                            <li class="menu-item {{ Request::is('admin/vehicles*') && !Request::is('admin/vehicles/create*') ? 'menu-item-active' : ''}}" aria-haspopup="true">
                                                <a href="{{ route('vehicle.index') }}" class="menu-link btn-comingsoon">
                                                    <i class="menu-bullet menu-bullet-line">
                                                        <span></span>
                                                    </i>
                                ...
                                <!-- BEGIN TRANSACTION -->
                                <li class="menu-section">
                                    <h4 class="menu-text">Transaction</h4>
                                    <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                                </li>
